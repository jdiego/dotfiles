...
return packer.startup(function(use)
    ...
    use { "nvim-lualine/lualine.nvim", commit = "a52f078026b27694d2290e34efa61a6e4a690621" } -- A blazing fast and easy to configure statusline plugin
    ...
    use { "mfussenegger/nvim-dap", commit = "6b12294a57001d994022df8acbe2ef7327d30587" } -- A DAP client implementation for Neovim
    use { "rcarriga/nvim-dap-ui", commit = "1cd4764221c91686dcf4d6b62d7a7b2d112e0b13" } -- A UI for nvim-dap which provides a good out of the box configuration
